...
public class Article implements Serializable, SourceBook {
    ...
    @Override
    public void setInformationElement(Integer index, int element) {
        information.set(index, element);
    }
    ...
    public void output(OutputStream outputStream) throws IOException {
        ...
        objectOutputStream.writeUTF("Article");
        objectOutputStream.writeObject(information);
        objectOutputStream.writeUTF(name);
        objectOutputStream.writeInt(numberInformationPages);
    ...
    public void write(Writer writer) throws IOException {
        ...
        bufferedWriter.write(information.toString());
        bufferedWriter.newLine();
        bufferedWriter.write(name);
        bufferedWriter.newLine();
        bufferedWriter.write(numberInformationPages.toString());
